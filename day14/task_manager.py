...
from day14.task_state_machine import TaskState, TaskEvent, TaskStateMachine
from day14.invariant import InvariantManager
...
class TaskManager:
    ...
    Пожалуйста, предложи альтернативный план, который НЕ нарушает инварианты.
    Инварианты:
